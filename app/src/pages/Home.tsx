    ...
    <div className="flex flex-col items-center min-h-screen bg-gray-100 pt-20">
      ...
      <div className="flex flex-col mt-10 w-96">
        <input
          ...
          className="w-full mr-2 px-4 py-2 border rounded-full focus-visible:border-[#508d0d] focus-visible:ring-[#508d0d]"
        />
        <textarea
          placeholder="Write your message"
          value={message}
          onChange={(e) => setMessage(e.target.value)}
          className="w-full h-32 mt-4 px-4 py-2 border rounded-2xl resize-none focus-visible:border-[#508d0d] focus-visible:ring-[#508d0d]"
        />
        ...
        <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4">
            ...
            >
              ...
              <div ref={qrCodeRef} style={{width:"128px",height:"128px"}}>
              <QRCode value={qrCodeValue} />
              </div>
              <div className="mt-4">
                <button onClick={handleQRCodeDownloadClick} className="px-4 py-2 bg-green-500 text-white rounded-md mr-4">Download</button>
        ...
        <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4">
            ...
            >
              ...
              This application allows you to generate a QR code based on your input message. Simply enter your name and message, click on "Generate QR Code", and a unique QR code will be created. You can download or share this QR code directly from the application.
              </p>
              <div className="mt-4">
                <Button
                  className="inline-flex items-center gap-2 rounded-md bg-gray-700 py-1.5 px-3 text-sm/6 font-semibold text-white shadow-inner shadow-white/10 focus:outline-none data-[hover]:bg-gray-600 data-[focus]:outline-1 data-[focus]:outline-white data-[open]:bg-gray-700"
